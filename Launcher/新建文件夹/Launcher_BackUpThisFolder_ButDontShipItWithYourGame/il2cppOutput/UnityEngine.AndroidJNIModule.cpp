...
IL_0047:
	...
	{// begin try (depth: 1)
		...
		}
		{
			...
			L_25 = VirtualFuncInvoker1< MethodInfoU5BU5D_tDF3670604A0AECF814A0B0BA09B91FBF0D6A3265*, int32_t >::Invoke(129 /* System.Reflection.MethodInfo[] System.Type::GetMethods(System.Reflection.BindingFlags) */, L_23, L_24);
			V_12 = L_25;
			V_13 = 0;
...
IL_00a5_1:
		{
			...
			L_37 = VirtualFuncInvoker0< ParameterInfoU5BU5D_t86995AB4A1693393FE29B058CC3FD727DF0B984C* >::Invoke(20 /* System.Reflection.ParameterInfo[] System.Reflection.MethodBase::GetParameters() */, L_36);
			V_17 = L_37;
...
IL_00fa_1:
		{
			...
			NullCheck(L_57);
			bool L_62;
			L_62 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(27 /* System.Boolean System.Type::IsAssignableFrom(System.Type) */, L_57, L_61);
...
IL_021b:
	{
		...
		NullCheck(L_78);
		bool L_81;
		L_81 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(165 /* System.Boolean System.Type::Equals(System.Type) */, L_78, L_80);
		V_17 = L_81;
		bool L_82 = V_17;
		if (!L_82)
		{
...
IL_023d:
	{
		...
		NullCheck(L_83);
		bool L_86;
		L_86 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(165 /* System.Boolean System.Type::Equals(System.Type) */, L_83, L_85);
		V_18 = L_86;
		bool L_87 = V_18;
		if (!L_87)
		{
...
IL_025f:
	{
		...
		NullCheck(L_88);
		bool L_91;
		L_91 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(165 /* System.Boolean System.Type::Equals(System.Type) */, L_88, L_90);
		V_19 = L_91;
		bool L_92 = V_19;
		if (!L_92)
		{
...
IL_02dd:
	...
	}
	{
		...
		NullCheck(L_111);
		int32_t L_112;
		L_112 = VirtualFuncInvoker0< int32_t >::Invoke(55 /* System.Int32 System.Type::GetArrayRank() */, L_111);
...
IL_0312:
	{
		...
		NullCheck(L_119);
		Type_t* L_120;
		L_120 = VirtualFuncInvoker0< Type_t* >::Invoke(54 /* System.Type System.Type::GetElementType() */, L_119);
		String_t* L_121;
